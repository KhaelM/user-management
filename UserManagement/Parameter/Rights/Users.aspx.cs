    ...
    public partial class Users : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["UserId"] != null)
            {
                ...
                if (IsPostBack)
                {
                    if (Request.Form[users.UniqueID] != null)
                        users.Value = Request.Form[users.UniqueID].ToString();
                    ...
                    try
                    {
                        user.ModifyUsersRightsOnDataTable(Request.Form[users.UniqueID], Request.Form[tables.UniqueID], Request.Form["rights"]);
                    }
                    catch (Exception exc)
                    {

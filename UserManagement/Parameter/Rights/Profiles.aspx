<%@ Page Title="Droits Profils" Language="C#" MasterPageFile="~/Template.Master" AutoEventWireup="true" CodeBehind="Profiles.aspx.cs" Inherits="UserManagement.Parameter.Profiles" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <div runat="server" id="content">
        <div class="form-group row mt-3">
            ...
            <div class="col-sm-8">
                <input runat="server" class="form-control" id="profiles" placeholder="Ex: PFL1;PFL2 ou % pour tous">
            </div>
        </div>
